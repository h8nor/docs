...
(последнее обноаление в сентябре 2020).
...
| |-|Сервисы Google Play|20.4|457.0|нельзя отключить автозапуск и автообновления (Контакты 3.5 и Сообщения 3.7 требуют все разрешения этого приложения) :angry:
