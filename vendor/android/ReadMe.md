...
|2019-09-20|-|Discord: Chat|10.0|88.3|Камера, Контарты, Микрофон, Память, Play Install Rerferrer API
|2018-05-02|$|DomoMeter: ЖКУ|3.8|12.2|Камера, Контакты, Память (требует)
|2019-09-16|-|DuckDuckGo: Browser|5.36|32.0|Память, Play Install Rerferrer API
...
|2019-12-06|баннер|Rate&Goods| |80.7|Контакты, Камера (фото чека), Местоположение (требует по всем источникам), Память (фото чека), Доступ к настройкам BlueTooth *Требует много траффика*
...
|2019-11-21|баннер|Мосгорпасс: Map|5.2|71.2|Камера, Местоположение (требует), Телефон, Память
|2019-10-23|вкладка|Air Quality|5.3|55.6|Камера, Местоположение, Память, Play Install Rerferrer API
|2019-11-28|блок|Cube ACR|2.3|24.5|Контакты (просмотр), Микрофон, Память, Телефон, Play Install Rerferrer API
...
|2019-11-12|видео|Last Day on Earch: Survival|1.15|346.0|Wi-Fi
|2018-06-22|-|Medlux|1.06|19.6|Календарь, Местоположение
|2019-11-22|блок|Mi Fit|4.0|119.0|Местоположение, Телефон
|2019-12-02|вкладка|Money Pro|2.3|77.0|Память (backup)
