...
PDF, RTF, DOCX, справки Qt, а также EPUB и Amazon Kindle совместимых электронных книг. Работа в прогррамме 
с текстом ничем не отличается от программы MS Word 2010.  
...
- ***Doc_html_mods.vbs*** - модификация готовой HTML документации
